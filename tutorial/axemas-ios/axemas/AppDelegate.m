...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [NavigationSectionsManager registerController:[NativeSectionController class] forRoute:@"www/native.html"];
    [NavigationSectionsManager registerController:[BaseSectionController class] forRoute:@"www/sidebar.html"];
