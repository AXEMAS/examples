...
public class AXMActivity extends Activity implements SectionFragment.SectionFragmentActivity, AnimationLayout.Listener {
    ...
    private void replaceActionBar(String resourceName, String title) {
        ActionBar mActionBar = getActionBar();
        mActionBar.setDisplayShowHomeEnabled(false);
        mActionBar.setDisplayShowTitleEnabled(false);

        View view = LayoutInflater.from(this).inflate(it.axant.navigation.R.layout.axemas_action_bar, null);
        actionBarTitle = (TextView) view.findViewById(it.axant.navigation.R.id.action_bar_title);
        actionBarTitle.setText(title);

        actionBarButton = (ImageButton) view.findViewById(it.axant.navigation.R.id.action_bar_button);
    ...
    protected void showProgressDialog() {
        if (progressDialog == null) {
            progressDialog = new ProgressDialog(this, it.axant.navigation.R.style.ProgressDialogTheme);
    ...
    protected void showDismissibleAlertDialog(String title, String message) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(new ContextThemeWrapper(
                this, it.axant.navigation.R.style.CustomAlertDialogStyle));
        alertDialogBuilder.setTitle(title);
        alertDialogBuilder
                .setMessage(message)
                .setCancelable(false)
                .setNegativeButton(getString(it.axant.navigation.R.string.dialog_close_button), new DialogInterface.OnClickListener() {
    ...
    private void pushFragment(Fragment fragment, String tag) {
        ...
        transaction.add(it.axant.navigation.R.id.currentSection, fragment, tag);
    ...
    private void popFragments(int fragmentsToPop) {
        ...
        int limit = Math.min(fragmentsToPop, fragmentStack.size());
        ...
        if (backButtonEnabled) {
            if (animationLayout.isOpening()) {
                ...
                if (fragmentStack.size() > 1) {
                    ...
                    Toast.makeText(this, getString(it.axant.navigation.R.string.press_again_to_exit), Toast.LENGTH_SHORT).show();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        replaceActionBar("icon_sidebar", "");
        setContentView(it.axant.navigation.R.layout.activity_with_sidebar_axm);
        fragmentStack = new Stack<Fragment>();

        this.registeredControllers = new HashMap<String, Class>();
        animationLayout = (AnimationLayout) findViewById(it.axant.navigation.R.id.animation_layout);
    ...
    protected void makeApplicationRootController(JSONObject dataObject, String sidebarUrl) {
        ...
        sidebarTransaction.replace(it.axant.navigation.R.id.sidebarSection, sidebarFragment, "sidebar_fragment");
